...
export function format(...args) {
    ...
    for(let i = lastArgUsed; i < args.length; i++){
        ...
        if (typeof args[i] === "string") {
            result += args[i];
        } else result += Deno.inspect(args[i], {
            colors: true
        });
    }
    return result;
